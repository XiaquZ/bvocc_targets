...
tar_plan(
  tolerance = 0.25,
  max_distance = 100000,
  present_files = list.files("/lustre1/scratch/348/vsc34871/input/BVoMC/preFrance/", full.names = T),
  future_files = list.files("/lustre1/scratch/348/vsc34871/input/BVoMC/futFrance/", full.names = T),
