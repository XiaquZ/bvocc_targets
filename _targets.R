...
tar_plan(
  tolerance = 0.25,
  max_distance = 75000,
  present_files = list.files("/lustre1/scratch/348/vsc34871/input/VoCC/prePTES/", full.names = T),
  future_files = list.files("/lustre1/scratch/348/vsc34871/input/VoCC/futPTES/", full.names = T),
